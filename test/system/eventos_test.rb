...
class EventosTest < ApplicationSystemTestCase
  ...
  test "creating a Evento" do
    ...
    fill_in "Dia", with: @evento.dia
    fill_in "Estado", with: @evento.estado
    fill_in "Grupo evento", with: @evento.grupo_evento_id
    fill_in "Horario", with: @evento.horario
    fill_in "Prioridade", with: @evento.prioridade
